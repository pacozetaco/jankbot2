...
ARK_CHAT_CHANNEL = os.getenv("ARK_CHAT_CHANNEL")
ARK_SERVER_NAME = os.getenv("ARK_SERVER_NAME")
ARK_SERVER_PASS = os.getenv("ARK_SERVER_PASS")
JUKEBOX_INFO_CHANNEL = os.getenv("JUKEBOX_INFO_CHANNEL")
